<template>
<div class="flex-1">
    <p class="text-stone-50 text-xl font-medium text-center">Hardware</p>
    <button @click="onClick" class="bg-stone-300 hover:bg-stone-200 text-stone-900 font-bold py-2 px-4 border-b-4 border-stone-500 hover:border-stone-300 rounded">Choose Hardware</button>
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                  <div class="sm:flex sm:items-start">
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      <DialogTitle as="h3" class="text-lg font-medium leading-6 text-gray-900">Select your hardware</DialogTitle>
                      <div class="mt-2">
