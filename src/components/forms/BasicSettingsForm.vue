        ...
        <div class="pt-8">
          <div>
            ...
            <p class="mt-1 text-sm text-gray-500">
              Save your customizations for later use. Settings are saved to your
              computer.
            </p>
          </div>
            ...
            <div class="sm:col-span-4">
              <div class="relative flex items-start">
                ...
                <div class="ml-3 text-sm">
                  <label for="saveSettings" class="font-medium text-gray-700"
                    >Save My Settings</label
                  >
                  <p class="text-gray-500">
                    Sensitive data (like your wifi password) is never shared
                    with PrintNanny.
                  </p>
                </div>
              </div>
              ...
              <div class="sm:col-span-6">
                <div class="relative flex items-start">
                  ...
                  <div class="ml-3 text-sm">
                    ...
                    >
                    <p class="text-gray-500">
                      Secure Shell (SSH) allows you to log into your Raspberry
                      Pi from a terminal on another computer.
                    </p>
                  </div>
                </div>
              </div>
...
const schema = yup.object({
  ...
  disableSSHPassword: yup.bool().default(false),
