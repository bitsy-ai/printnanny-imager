<template>
  <div class="container m-auto">
    <h2 class="text-gray-900 text-center text-3xl mb-4 mt-4">Configure Operating System</h2>
    <div class="sm:hidden">
    ...
    >
      <li class="w-full">
        <a
          class="inline-block p-4 w-full text-gray-900 bg-white rounded-l-lg focus:ring-4 focus:ring-blue-300 focus:outline-none dark:bg-gray-700 dark:text-white"
          aria-current="page"
          :class="configMode == 'basic' ? 'bg-gray-100' : 'bg-white'"
          @click="() => setConfigMode('basic')"
          >Basic</a
        >
      </li>
      <li class="w-full">
        <a
          ...
          :class="configMode == 'advanced' ? 'bg-gray-100' : 'bg-white'"
          @click="() => setConfigMode('advanced')"
          >Advanced</a
        >
      </li>
    </ul>

    <BasicSettingsForm v-if="configMode == 'basic'"></BasicSettingsForm>
    <AdvancedSettingsForm
      v-if="configMode == 'advanced'"
    ></AdvancedSettingsForm>
  </div>
</template>
...
import AdvancedSettingsForm from "../forms/AdvancedSettingsForm.vue";

const configMode = ref("basic");

function setConfigMode(mode: string) {
  console.log(mode);
